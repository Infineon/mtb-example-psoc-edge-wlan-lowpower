...
The following example clones the "[WLAN low power](https://github.com/Infineon/mtb-example-psoc-edge-wlan-low-power)" application with the desired name "WlanLowPower" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-wlan-low-power --user-app-name WlanLowPower --target-dir "C:/mtb_projects"
   ```
